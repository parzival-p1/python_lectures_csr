...
class Invoice_interface:
    ...
    def new_invoice(self):
        ...
        self.txt_year = ttk.Combobox(self.new_label_frame, width=18,
    ...
    def show_delete_details(self):
        if self.txt_select_car.get() != "":
            self.car_details.place(x=10,
                                   y=130)  # brand, model, transmission, color, price, year, km, car_type, fuel, id, stock
